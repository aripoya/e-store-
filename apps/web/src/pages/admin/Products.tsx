...
import { adminGetProducts, adminCreateProduct, adminUpdateProduct, adminDeleteProduct, adminUploadFile } from '../../services/api';
...
export default function AdminProducts() {
  ...
  const handleFileUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      setFormData({ ...formData, file_url: uploadedFile.fileName });
      alert(`File uploaded successfully: ${uploadedFile.originalName}`);
    } catch (error: any) {
              ...
              <div>
                ...
                {formData.file_url && (
                  <p className="mt-2 text-sm text-green-600">
                    ✓ File uploaded: {formData.file_url}
                  </p>
                )}
              </div>
